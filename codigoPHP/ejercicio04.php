...
<body>
	...
	<main>
		<div class="contenido">
			<h2>Ejercicio 04 </h2>
			<p>MOSTRAR EN TU PAGINA INDEX LA FECHA Y LA HORA ACTUAL FORMATEADA EN PORTUGUES OPORTO</p>
			<?php
			/**
			...
			//Inicializamos la variable $oFechaActual mediante la clase DateTime pasandole como parametro la hora actual (now) y la zona horaria de (Europa/Lisbon)
			$ofechaHoraActual = new DateTime('now', new DateTimeZone('Europe/Lisbon'));
	
	        //Mediante echo mostramos en pantalla el contenido de la variale anterior formateado
			echo 'Fecha y hora actual en Oporto: ' . $ofechaHoraActual->format('Y-m-d / H:i:s');
			?>
