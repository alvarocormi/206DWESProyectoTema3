...
<body>
	...
	<main>
		<div class="contenido">
			<h2>Ejercicio 10 </h2>
			<p>MOSTRAR EL CONTENIDO DEL FICHERO QUE SE ESTA EJECUTANDO</p>
			<?php
			/**
			 ...
			 * @since 11/10/2023
			 */
			// htmlentities -> Muestra el contenido en un elemento HTML <pre> para mantener el formato
			// file_gte_contents -> Muestra el contenido de un archivo pasandole como parametro la ruta de este archivo.
