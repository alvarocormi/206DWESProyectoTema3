...
<body>
	...
	<main>
		<div class="contenido">
			<h2>Ejercicio 09 </h2>
			<p>MOSTRAR EL PATH DONDE SE ENCUENTRA EL FICHERO QUE SE ESTA EJECUTANDO</p>
			<?php
			/**
			...
			//__FILE__ es una constante magica de php que nos permite mostrar el path donde se encuentra el fichero que se esta ejecutando
			echo "El archivo actual se encuentra en la ruta:".  __FILE__;
			?>
