...
<body>
	...
	<main>
		<div class="contenido">
			<h2>Ejercicio 22 </h2>
			<p>MOSTRAR EL RESULTADO DE UN FORMULARIO EN LA MISMA PAGINA</p>
			...
			if (isset($_POST["enviar"])) {
				//Recogemos el valor de las variables del formulario
			...
			?>	
				<form action="<?php $_SERVER['PHP_SELF'] ?>" method="post">
					<p style="color: black">Su nombre: <input type="text" name="nombre" /></p>
					<p style="color: black">Su edad: <input type="text" name="edad" /></p>
					<p style="color: black">Su password: <input type="password" name="password" /></p>
