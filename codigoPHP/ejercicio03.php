...
<body>
	...
	<main>
		<div class="contenido">
			<h2>Ejercicio 03 </h2>
			<p>MOSTRAR EN TU PAGINA INDEX LA FECHA Y LA HORA ACTUAL FORMATEADA EN CASTELLANO</p>
			<?php
			/**
			 ...
			 */
			 ...
			 //Inicializamos una variable que contenga la fechayHora Actual utilizando la clase DateTime
			$ofechaHoraActual = new DateTime('now', new DateTimeZone('Europe/Madrid'));
			$fechaActual = date('Y-m-d');
			
			//Mediante echo mostramos por pantalla la fechayHora formateada
			echo 'Fecha y hora actual en castellano: ' . $ofechaHoraActual->format('H:i:s'). ' / '. $fechaActual;
			?>
