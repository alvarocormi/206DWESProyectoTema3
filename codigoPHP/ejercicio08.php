...
<body>
	...
	<main>
		<div class="contenido">
			<h2>Ejercicio 08 </h2>
			<p>MOSTRAR LA DIRECCION IP DEL EQUIPO DESDE EL QUE ESTAS ACCEDIENDO</p>
			<?php
			/**
			...
			//Mediante la variable global _SERVER podemos averiguar la direccion IP del equipo pasandole la clave de 'REMOTE_ADDR'
			echo 'La dirección IP del equipo desde el que estás accediendo es: ' . $_SERVER['REMOTE_ADDR'];
			?>
