...
<body>
	...
	<main>
		<div class="contenido">
			<h2>Ejercicio 17 </h2>
			<p>INICIALIZAR UN ARRAY BIDIMENSIONAL</p>
			<?php
			/**
			...
			for ($fila = 0; $fila <= 20; $fila++) {
				echo "Fila $fila: ";
				for ($asiento = 0; $asiento <= 15; $asiento++) {
					//Si algun asiento del teatro no es nulo ni vacio lo mostrara por pantalla
					if (isset($aTeatro[$fila][$asiento])) {
						echo "Asiento $asiento - " . $aTeatro[$fila][$asiento] . ", ";
					}
				}
				echo "<br>";
			}
