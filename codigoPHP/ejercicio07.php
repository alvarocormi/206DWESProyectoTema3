...
<body>
	...
	<main>
		<div class="contenido">
			<h2>Ejercicio 07 </h2>
			<p>MOSTRAR EL NOMBRE DEL FICHERO QUE SE ESTA EJECUTANDO</p>
			<?php
			/**
			 * 
			...
			//__FILE__ es una constante que transifiere un fichero completo a un array
			echo 'El nombre del archivo en ejecución usando la variable __FILE__ es: ' . __FILE__ .'</br>';
			echo 'El nombre del archivo en ejecucion usando la variable $SERVER es: '. $_SERVER["SCRIPT_FILENAME"];
			?>
