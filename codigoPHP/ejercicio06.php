...
<body>
	...
	<main>
		<div class="contenido">
			...
			$ofechaFutura = clone $ofechaActual;

			// Sumar 60 días a la fecha futura
			$ofechaFutura->add(new DateInterval('P60D'));

            //Mediante echo mostramos el contenido de las variables
			echo 'Fecha actual: ' . $ofechaActual->format('Y-m-d') . '<br>';
			echo 'Fecha dentro de 60 días: ' . $ofechaFutura->format('Y-m-d') . '<br>';
			echo 'Día de la semana dentro de 60 días: ' . $ofechaFutura->format('l');
			?>
