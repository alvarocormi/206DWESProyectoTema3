...
<body>
	...
	<main>
		<div class="contenido">
			<h2>Ejercicio 14</h2>
			<p>CREA TU PROPIA LIBRERIA DE FUNCIONES Y USALA EN ENTORNO DE DESARROLLO Y EXPLOTACION</p>
			<?php
                    /**
                     ...
                     */
                    include_once '../core/funcionCalculadoraAlvaro.php';

                    echo("El resultado de la suma es: ".suma(2, 5));
                    echo('<br>');
                    echo("El resultado de la resta es: ".resta(20, 5));
                    echo('<br>');
                    echo("El resultado de la multiplicación es: ".multiplicar(10, 2));
                    echo('<br>');
                    echo("El resultado de la multiplicación es: ".dividir(20, 5));
                    ?>
